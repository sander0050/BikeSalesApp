...
namespace BikeSalesApp.Controllers
{
    public class StocksController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StockId,StoreId,ProductId,Quantity")] Stock stock)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StockId,StoreId,ProductId,Quantity")] Stock stock)
        {
            if (ModelState.IsValid)
            {
