...
namespace BikeSalesApp.Controllers
{
    public class StaffsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StaffId,FirstName,LastName,Phone,Email,Active,StoreId")] Staff staff)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StaffId,FirstName,LastName,Phone,Email,Active,StoreId")] Staff staff)
        {
            if (ModelState.IsValid)
            {
